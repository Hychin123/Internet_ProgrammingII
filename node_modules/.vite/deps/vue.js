...
function createTransformContext(root, {
  ...
  directiveTransforms = {},
  transformHoist = null,
  isBuiltInComponent = NOOP3,
  isCustomElement = NOOP3,
  expressionPlugins = [],
  scopeId = null,
  slotted = true,
  ssr = false,
    ...
    if (p2.type === 6) {
      ...
      if (p2.name === "bind" && isStaticArgOf(p2.arg, "name")) {
        if (p2.exp) {
          ...
          const name = camelize3(p2.arg.content);
...
var transformBind = (dir, _node, context) => {
  ...
  if (!exp) {
    ...
    const propName = camelize3(arg.content);
...
var GLOBALS_ALLOWED4 = "Infinity,undefined,NaN,isFinite,isNaN,parseFloat,parseInt,decodeURI,decodeURIComponent,encodeURI,encodeURIComponent,Math,Number,Date,Array,Object,Boolean,String,RegExp,Map,Set,JSON,Intl,BigInt,console,Error";
var isGloballyAllowed4 = makeMap4(GLOBALS_ALLOWED4);
...
var isMathMLTag4 = makeMap4(MATH_TAGS4);
...
var parserOptions = {
  ...
  isNativeTag: (tag) => isHTMLTag4(tag) || isSVGTag4(tag) || isMathMLTag4(tag),
...
var capitalize5 = cacheStringFunction5((str) => {
  return str.charAt(0).toUpperCase() + str.slice(1);
});
var toHandlerKey5 = cacheStringFunction5((str) => {
  const s = str ? `on${capitalize5(str)}` : ``;
  return s;
});
var GLOBALS_ALLOWED5 = "Infinity,undefined,NaN,isFinite,isNaN,parseFloat,parseInt,decodeURI,decodeURIComponent,encodeURI,encodeURIComponent,Math,Number,Date,Array,Object,Boolean,String,RegExp,Map,Set,JSON,Intl,BigInt,console,Error";
var isGloballyAllowed5 = makeMap5(GLOBALS_ALLOWED5);
var range = 2;
...
var MATH_TAGS5 = "annotation,annotation-xml,maction,maligngroup,malignmark,math,menclose,merror,mfenced,mfrac,mfraction,mglyph,mi,mlabeledtr,mlongdiv,mmultiscripts,mn,mo,mover,mpadded,mphantom,mprescripts,mroot,mrow,ms,mscarries,mscarry,msgroup,msline,mspace,msqrt,msrow,mstack,mstyle,msub,msubsup,msup,mtable,mtd,mtext,mtr,munder,munderover,none,semantics";
...
var isMathMLTag5 = makeMap5(MATH_TAGS5);
...
function getCache(options) {
  let c = compileCache.get(options != null ? options : EMPTY_OBJ5);
  if (!c) {
    c = /* @__PURE__ */ Object.create(null);
    compileCache.set(options != null ? options : EMPTY_OBJ5, c);
  }
  return c;
}
